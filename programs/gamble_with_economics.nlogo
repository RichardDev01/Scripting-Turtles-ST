globals [gamble_money_spent goverment_money jackpot trades] ;;eigen toevoeging

turtles-own [ wealth gambler_r salary] ;;eigen toevoeging van salary

to setup
  clear-all
  set gamble_money_spent 0 ;;eigen toevoeging
  set trades 0
  create-turtles 500 [
    set wealth 100
    set shape "circle"
    ...
    ;; Persoonlijkheid
    set gambler_r random 10 ;;eigen toevoeging, Dit geeft elke agent een persoonlijkheid van gokken

    set salary random 30 ;;eigen toevoeging, Dit geeft elke agent een willekeurig salaris per maand wat in het begin gedefineerd is
...
to go
  if ticks mod 30 = 0 [ ask turtles [set wealth wealth + salary]] ;;eigen toevoeging, elke 30 ticks worden gezien als een maand salaris dag
  set jackpot jackpot + goverment_money / 100                     ;;eigen toevoeging, jackpot prijzen pot geld geven vanuit het geld van de overheid
  ...
  ask turtles [ if wealth > gamble_price and  gambler_r > gambler_rate [ gamble ] ]   ;;eigen toevoeging, als een turtle genoeg geld heeft om te gokken en heeft een hoog genoegen gok persoonlijkheid, dan gokken
